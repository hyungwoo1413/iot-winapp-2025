...
namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(TxtYear, "캘린더 선택 연도 표시 텍스트박스입니다.");
        ...
        private void ChangeFont()
        {
            ...
            TxtResult.Font = new Font((string)CboFonts.SelectedItem, TxtResult.Font.Size, style);
        }
        ...
        private void TreeToList(TreeNode node)
        {
            ...
            item.ImageIndex = 0;  // 아이템의 이미지 인덱스를 지정
        ...
        {
            MessageBox.Show(DtpBirth.Value.ToShortDateString(), "생일", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        {
            if (MessageBox.Show("종료하시겠습니까?", "종료", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                this.FormClosing -= FrmMain_FormClosing;  // 폼 클로징 이벤트를 삭제
