...
- Visual Studio Installer 확인
    ...
    <img src="./image/cs/cs0001.png" width="700">
...
- C# 유머
    ...
    - C#의 의미는 C++보다 개선된 언어로 C++++, 또는 음악에서 #이 원래 음보다 반음 높음을 뜻

- C# 버전
    - C# 1.x - 2002 ~ 2003년. .NET Framework 1.x 문제가 많음
    - C# 2.x - 2006년. .NET Framework 2.x 개선이 많이 됨
    - C# 3.x - 2007년. .NET Frameworek 2.x~3.5 Java와 차이가 많아짐
...
- 2016년 부터 리눅스 지원시부터 .NET Framework가 너무 윈도우 구조에 너무 토착되다보니 새로운 프레임워크가 필요함
...
- `C# 12.0`, .`NET 8`, `Visual Studio 2022` Community Edution에서 학습
...
- 순서
    1. 언어, 플랫폼, 프로젝트 선택
        ...
        - 플랫폼 : 모든 플랫폼
        - 프로젝트 : 데스크톱 선택
    2. Windows Froms 앱 선택 (.NET Framework가 안 적힌 것)
    3. 프로젝트 명 입력
    4. 추가 정보
        - 프레임워크 : .NET 8.0 (장기지원) 선택
...
- 굵은 글씨체로 나오는 프로젝트가 시작 프로젝트
    1. 시작 프로젝트로 변결할 프로젝트 > 마우스 오른쪽 > 시작 프로젝트로 설정
    2. 전체 솔루션 > 속성 > 속성 페이지
...
6. 속성 창 - 드롭다운 컨트에서 선택 > 여러 클래스 리스트

7. button1 속성 변경
    - (Name) > button1 -> BtnMsg변경
    - Size 조정
...
11. 오류 발생 시
    ...
    - 이벤트 이름은 생성되고, 이베트 정의 메서드는 생성이 안되서

    <img src="./image/cs/cs0002.png" width="600">

    - FromMain.Designer.cs 파일 오픈
...
- `TextBox` : 텍스트 입력을 위한 컨트롤
    ...
    - Multiline : 여러줄 사용여부. true가 되어야 높아 조절 가능
...
- 기본 문법 - C++, Java와 거의 동일. C++와의 차이점만 비교
    ...
    2. 자료형과 변수, Nullable - [소스](./day02/Day02Study/SyntaxWinApp01/FrmMain.cs)
        ...
        - var타입 : 지역변수에서 타입을 동적으로 지정. 컴파일시 해당 타입으로 자동 지정
            - 지역변수만 가능(전역변수 사용불가)
            - 한번 타입이 지정되는 다른 타입으로 변경불가
        
    3. 연산자 - [소스](./day02/Day02Study/SyntasWinApp02/FrmMain.cs)
    - C, C++과 동일! 패스!!
    ...
    4. 분기문, 반복문 - [소스](./day02/Day02Study/SyntaxWinApp03/FrmMain.cs)
        ...
        <img src="./image/cs/cs0003.png" width="600">
...
### 한글문제
- 한글 깨지는 문제
- 콘솔 > Program.cs : UTF9 Bom 저장
- 윈앱 > FrmMain.cs : EUC-KR(CP949) -> 깃헙에서 한글이 꺠져서 나옴
...
- `PictureBox` : 이미지를 표현해주는 컨트롤
    ...
    - SizeMode : 들어가는 이미지 사이즈형태
        ...
        - StrechImage : 픽처박스 크기에 맟춰서 표시
        - AutoSize : 이미지 크기에 픽처박스 크기 조정
        - ConterImage : 이미지를 중앙에 표시
        - Zoom : 확대표시(?)
    - 들어갈 이미지의 속성
        - 출럭 디렉토리로 복사 : 항상 복사 변경

### 윈앱 개발기능
1. Debug - 디버깅시 필요한 기능 담은 클래스
    - Debug.WriteLine() : 디버스 > 창 > `출력`에 디버깅 로그 출력
    - 디버깅 시작으로 실행 시만 출력
2. 프로젝트 속성
...
- 기본 문법
    1. 문자열 처리 - [소스](./day02/Day02Study/SyntaxWinApp04/FrmMain.cs)
        ...
        <img src="./image/cs/cs0004.png" width="600">
    ...
    3. 접근제어자
        ...
        <img src="./image/cs/cs0006.png" width="600">
    ...
    4. 상속, 다형성, 추상클래스, 인터페이스 - [소스](./day03/Day03Study/SyntaxWinApp02/Computer.cs)
        ...
        <img src="./image/cs/cs0005.png" width="600">
...
- 보기 > 개체브라우저에서 필요한 클래스 검색
- 소스코드가 회색으로 연하게 변하는 것 > 되도록이면 사용을 피하라는뜻 > Alt + Enter로 변경권장사항 확인
...
- 기본문법
    ...
    2. 예외처리
        ...
        <img src="./image/cs/cs0007.png" width="600">

        https://github.com/user-attachments/assets/a0feb3c3-1583-4a80-a57b-5f3b808652c9
...
- `StatusStrip` : 상태표시줄 컨트롤. 서브 컨트롤 추가 가능
    ...
    - `ProfressBar` : 진행바 표시, Prg~ 이름 시작
    - `DorpDownButton` : 드롭다운버튼 추가, 이벤트 추가
    - `SplotButton` : 버튼, 이벤트 추가
...
- 기본 문법
    1. 델리게이트(대리자), 이벤트 - [소스](./day05/Day05Study/SyntaxWinApp01/FrmMain.cs)
        ...
        - 원폼에서 버튼을 클릭하면, 직접 메서드를 호출하는게 아니고, C#에 사용자의 움직임을 체크하고 있다가 클릭`이벤트가 발생하면 그에 해당하는 메서드를 대신 실행(호출)` 시켜주는 것
        ...
        - Form 오픈 이벤트 및 생성자
            ...
            2. `FrmMain_Load` 이벤트 : 폼이 로드(메모리 업)될때 처리할 내용
                - 생성자 이외에 초기화 할 것
                - 폼오픈시 이벤트 중에서 가장 중요!!!
            - FrmMain_Shown 이벤트 : 폼이 바탕화면에 그려질때 이벤트
                - 잘 안씀
            - FrmMain_Activated 이벤트 : 폼이 활성화(바탕화면 가장 위에서 동작하는 상태) 될때 처리될 이벤트
    ...
    <img src="./image/cs/cs0011.png" width="600">
...
- 고급 문법 
    ...
    3. 속성 - Property
        ...
        - UI 클래스(속성) : UI 상태나 외형, 기능 컨트롤
            - 폼 디자인, 코드 둘 다 사용
        - Form.Desinger.cs 내용은 폼 디자인에서 마우스나 디자인 설정에 변경하는 값으로 되도록이면
        수정하지 말 것
    ...
    5. 제네릭 : Generic
        ...
        <img src="./image/cs/cs0012.png" width="600">
    ...
    6. 비동기, 스레드 - [소스](./day05/Day05Study/SyntaxWinApp03/FrmMain.cs)
        ...
        <img src="./image/cs/cs0013.png" width="600">
...
- 윈앱 응용개발
    ...
    <img src="./image/cs/cs0014.png" width="700">
...
- WPF 특징
    ...
    - 백엔드는 C# 윈앱과 거의 동일, 프론트엔드만 차이
        - 윈앤과는 다르게 코딩으로 디자인을 수행. 윈앱처럼 디자이너 사용가능
        - 디자이너 -> Blend for Nisual Studio 디자인툴 사용
        - 개발자 -> VS에서 코딩으로 디자인

    <img src="./image/cs/cs0017.png" width="400">

- XAML 
    - eXtensible Application Markup Language : XML 기반 언어
    - WPF(Windows), UWP(Win, Linux, MacOS), MAUI(모바일) 동일하게 사용
    - 태크형태로 디자인. <열린태그></닫힌태크>, <태그내 다른 태그없을때 />
    ```xml
    <Window x:Class="ex01_wpf_start.MainWindow"
        ...
        <Grid>
            <Button x:Name="BtnClick" Content="CLICK" 
            FontSize="40" FontFamily="NanumGothic" 
...
- 각 프에임워크별 장점
    ...
    - WPF
        ...
        - GUP를 사용해서 GUI렌더링을 해서 윈앱보다 성능이 뛰어남
        - 모바일, UMP 등도 동일하게 개발가능
    
- WPF 컴포넌트(실무에서 쓰이는 UI컴포넌트, 윈앱도 존재) - Thrid Party
    - 참조 - 
...
- WPF 프로젝트 구조
    ...
    - MainWindow.xaml : Form1.Designer.cs와 동일한 디자인 파일
        - MainWindow.xaml.cs : Form1.cs소스코드와 동일
...
- WPF 실제개발법(XAML) - [소스](./day07/Day07Study/WpfStudyApp02/MainWindow.xaml)
    ...
    - **Grid** 컨트롤 : WPF에서 가장 많이 사용하는 레이아웃(중요!)
        ...
        - 중앙 외는 고정된 값으로 지정
        - 외부 Gird와 내부 Grid로 나눠서 작업 수행

        <img src="./image/cs/cs0015.png" width="600">
...
- 데이터바인딩 - [디자인](./day07/Day07Study/WpfStudyApp04/MainWindow.xaml), [소스](./day07/Day07Study/WpfStudyApp04/MainWindow.xaml.cs)
    ...
    - 바인딩 방식
        1. 직접코드 할당방식
            ...
            - DataContext와 관계 없음
            - 단순한 속성 사용방식
        2. XAML Binding 방식 : MVVM 디자인패턴 필수
            - {Binding fruitItems}
    ...
    - 바인딩 순서
        ...
        3. this.DataContext = this 로 할당 -> xaml 로 전달

    - 바인딩 모드 : 총 4가지 모드. 그중 2가지만 알면됨
        1. `TwoWay` : 사용중인 데이터가 변경되면 <-> 원본도 변경됨
        2. `OneWay` : 원본 데이터 -> 사용중인 데이터도 변경
        3. OneWayToSource : 사용중인 데이터 -> 원본을 변경
...
- 데이터베이스 데이터 바인딩
    ...
    3. 비하인드 코드에서 MySQL 소스 추가
        ...
        - 명령실행 객체 : MySqlCommand(쿼리문 실행)
        - 실행결과리더 객체 : MySqlDataReader(쿼리 결과 데이터)
        - 트랜잭션 객체 : 옵션 - 트랜잭션(INSERT, UPDATE, DELETE 쿼리) 처리시 필요

    <img src="./image/cs/cs0016.png" width="600">
...
- 컨트롤 디자인, 리소스 - [소스](./day08/Day08Study/WpfStudyApp04/MainWindow.xaml)
    ...
    - ResourceDictionary - [소스](./day08/Day08Study/WpfStudyApp04/App.xaml)
        ...
        <img src="./image/cs/cs0019.png" width="600">
...
- 연습예제
    ...
    <img src="./image/cs/cs0021.png" width="600">
...
- 기본 사용법 - [소스](./day09/Day09Study/WpfStudyApp07/MainWindow.xaml)
    ...
    - App.xaml 오픈 - [소스](./day09/Day09Study/WpfStudyApp07/App.xaml.cs)
        ```cs
...
<img src="./toyproject/image/2.png" width="600">
<img src="./toyproject/image/3.png" width="400">
<img src="./toyproject/image/4.png" width="600">
<img src="./toyproject/image/5.png" width="400">
...
2. 클라이언트 (C# WinForms)
    - 프로그램 시작 – Program.cs
        - FrmLogin 폼을 실행 → 로그인 성공 시 FrmMain 폼 실행 
        - 로그인에 필요한 TcpClient, NetworkStream, 사용자 정보 전달

    - 로그인 폼 – FrmLogin.cs, FrmLogin.Designer.cs
        - 서버에 LOGIN ID PW 메시지를 전송
