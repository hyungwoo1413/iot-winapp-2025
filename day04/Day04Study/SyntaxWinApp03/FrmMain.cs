namespace SyntaxWinApp03
{
    ...
    {
        private string filePath = "sample.rtf";  // Rich Text Format (msWord 와 유사)
        public FrmMain()
        {
            InitializeComponent();
        }
        ...
        private void BtnLoad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("파일이 존재하지 않습니다.", "파일 읽기", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            catch (Exception ex)
            {
        ...
        private void BtnRed_Click(object sender, EventArgs e)
        {
            ...
            //Color currColor = RtbNote.SelectionColor;
